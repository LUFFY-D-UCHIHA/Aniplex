...
module.exports = {
  ...
  return message.reply("Please provide a valid Facebook video URL or fb.watch URL.⚠");
      }
      ...
      if (videoSize.size > 45 * 1024 * 1024) {
        ...
        await message.reply({
          body: `Long Video can't be sent in HD; this video is in low quality.\\You can download it from Here in HD👇\HD Download link🔗 : ${hdVideoUrl}`,
          attachment: sdStream,
        });
        message.reaction("✅", event.messageID);
        ...
        await message.reply({
          body: `Here Is the video 🪄:\\Download link 🔗: ${hdVideoUrl}`,
